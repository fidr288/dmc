...
button.addEventListener("click", function(){
    ...
    if (total <= 5){
        ...
        document.getElementById("recommendation").innerHTML = "<h3>Clinical recommedations</h3><ul><li>smoking cessation</li><li>annual flu imm</li><li>reduce exposure to exacerbation risk factors</li><li>Therapy as warranted</li></ul>";
    } else if (total <= 20){
        ...
        document.getElementById("recommendation").innerHTML = "<h3>Clinical recommedations</h3><ul><li>Review maintenance therapy</li><li>referral to pulmonary rehab</li><li>minimise and manage exacerbations</li><li>still smoking?</li></ul>";
    } else if (total <= 30){
        ...
        document.getElementById("recommendation").innerHTML = "<h3>Clinical recommedations</h3><ul><li>Referral specialist care</li><li>additional pharmacological treatment in appropriate</li><li>referral to pulmonary rehab</li><li>minimise and manage exacerbations</li></ul>";
    } else{
